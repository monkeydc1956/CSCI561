...
from read import *
from write import *
# minVal improved, bettersore, hueristic
...
class GoPlayer:
    ...
    def minimax_pruning(self):
        ...
        if cur_step <= 2 and self.cur_board[2][2] == 0:
    ...
    #     next_board[step[0]][step[1]] = piece_type
    #     for index in range(len(self.next_steps)):
    #         tmp_i, tmp_j = step[0] + self.next_steps[index][0], step[1] + self.next_steps[index][1]
    #         if self.validationPos(tmp_i, tmp_j) and next_board[tmp_i][tmp_j] == 3 - piece_type:
    #             candy = []
    ...
    #                 dfs.add(tmp)
    #                 for index in range(len(self.next_steps)):
    #                     new_i, new_j = tmp[0] + self.next_steps[index][0], tmp[1] + self.next_steps[index][1]
    #                     if self.validationPos(new_i, new_j):
    #                         if (new_i, new_j) in dfs:
    #                             continue
    #                         elif next_board[new_i][new_j] == 0:
    #                             deleted = False
    #                             break
    #                         elif next_board[new_i][new_j] == 3-piece_type:
    #                             if (new_i, new_j) not in dfs:
    #                                 candy.append((new_i, new_j))
    #                             else:
    #                                 continue
    #             if deleted:
    #                 for stone in dfs:
    ...
    def location_evalution(self, cur_board, piece_type):
        ...
        #         pos_one_sq += self.square_one(mini_board, piece_type)
        #         dia_pos += self.diag_two(mini_board, piece_type)
        #         pos_three_sq += self.square_three(mini_board, piece_type)
        # for i in range(self.N):
        #     for j in range(self.N):
        #         mini_board = next_board[i: i + windows, j: j + windows]
        #         neg_one_sq += self.square_one(mini_board, 3 - piece_type)
        #         dia_neg += self.diag_two(mini_board, 3 - piece_type)
        #         neg_three_sq += self.square_three(mini_board, 3 - piece_type)
    ...
    #         tmp = candy.pop()
    #         dfs.add(tmp)
    #         cur_board[tmp[0]][tmp[1]] = 0
    #         for index in range(len(self.next_steps)):
    #             tmp_i, tmp_j = tmp[0] + self.next_steps[index][0], tmp[1] + self.next_steps[index][1]
    #             if self.validationPos(tmp_i, tmp_j):
    #                 if (tmp_i, tmp_j) not in dfs and cur_board[tmp_i][tmp_j] == piece_type:
    #                     candy.append((tmp_i, tmp_j))
    #     return cur_board
...
if __name__ == '__main__':
    ...
    action = my_player.minimax_pruning()
    writeOutput(action)
